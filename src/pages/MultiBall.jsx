...
export default function MultiBall() {
  const product = products.find((p) => p.slug === 'multiball')
  const images = galleryImages.filter((img) => img.category === 'MultiBall Setup')

  return (
    <>
      <SEO
        title="MultiBall Interactive Sports Wall"
        description="MultiBall is a projector-based interactive sports wall where players throw, kick, hit, and compete through digital games - perfect for exhibitions, corporate booths, and malls."
        path="/multiball"
      />
      ...
      <div className="pt-32 pb-16 bg-gradient-to-br from-[#0d1221] to-[#0a0e1a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="section-subtitle">MultiBall Experience</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <img src={product.image} alt={product.name} className="rounded-2xl w-full object-cover h-96 glow-blue" />
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            ...
            <h2 className="section-title">MultiBall <span className="text-gradient">Demo</span></h2>
          </div>
          <div className="max-w-2xl mx-auto">
            <VideoEmbed
              title="MultiBall Demo Video"
              description="Official MultiBall demo footage."
              officialUrl={product.videoChannel}
        ...
        {images.length > 0 && (
          <div className="mb-20">
            <div className="text-center mb-10">
              ...
              <h2 className="section-title">MultiBall <span className="text-gradient">Setups</span></h2>
            </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-black text-white mb-6">Bring MultiBall to Your Event</h2>
